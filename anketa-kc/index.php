    ...
    <div class="flex flex-col border-r border-gray-200 bg-gray-50" style="width:55%;min-width:300px;">
      ...
      <form id="anketa-form" class="hidden flex-1 panel-scroll px-4 pb-4 space-y-3" novalidate>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
          <button type="button" class="w-full flex items-center justify-between px-3 py-2 border-b border-gray-100 bg-gray-50 rounded-t-lg" data-collapse-toggle="finance-body">
            <span class="text-xs font-semibold text-gray-700">1. Финансовые данные</span>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
          <button type="button" class="w-full flex items-center justify-between px-3 py-2 border-b border-gray-100 bg-gray-50 rounded-t-lg" data-collapse-toggle="credit-body">
            <span class="text-xs font-semibold text-gray-700">2. Кредитная история</span>
            <svg class="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
          </button>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
          <button type="button" class="w-full flex items-center justify-between px-3 py-2 border-b border-gray-100 bg-gray-50 rounded-t-lg" data-collapse-toggle="personal-body">
            <span class="text-xs font-semibold text-gray-700">3. Личные данные</span>
            <svg class="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
          </button>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
          <button type="button" class="w-full flex items-center justify-between px-3 py-2 border-b border-gray-100 bg-gray-50 rounded-t-lg" data-collapse-toggle="manager-body">
            <span class="text-xs font-semibold text-gray-700">4. Заметки менеджера</span>
            <svg class="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
          </button>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
          <div class="flex items-center justify-between px-3 py-2 border-b border-gray-100 bg-gray-50 rounded-t-lg">
            <span class="text-xs font-semibold text-gray-700">5. Запись к специалисту</span>
          </div>
          <div id="booking-body" class="px-3 py-3 text-xs text-gray-400">Выберите МП и слот в расписании справа.</div>
        </div>
